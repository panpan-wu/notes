...
type = "file"
inputs = ["k8s"]
path = "/mnt/log/k8s_log/{{ .k8s.pod_namespace }}/{{ app_name }}/{{ tag }}-%Y-%m-%d.log.gz"
compression = "gzip"
encoding.codec = "json"
# k8s end
...
encoding.codec = "json"
compression = "gzip"
path = "/mnt/log/ecs_log/{{ app_name }}/{{ app_name }}-%Y-%m-%d-%H.log.gz"
...
encoding.codec = "json"
compression = "gzip"
path = "/mnt/log/ecs_log/{{ app_name }}/{{ app_name }}-%Y-%m-%d.log.gz"
# ecs end
